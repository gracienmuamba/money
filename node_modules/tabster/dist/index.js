...
class DummyInputManager {
  constructor(tabster, element, priority, outsideByDefault, callForDefaultAction) {
    this._element = element;
    this._instance = new DummyInputManagerCore(tabster, element, this, priority, outsideByDefault, callForDefaultAction);
...
class DummyInputManagerCore {
  constructor(tabster, element, manager, priority, outsideByDefault, callForDefaultAction) {
    var _a;
    ...
    this._isOutside = (outsideByDefault || tagName === "UL" || tagName === "OL" || tagName === "TABLE") && !(tagName === "LI" || tagName === "TD" || tagName === "TH");
...
class RootDummyManager extends DummyInputManager {
  constructor(tabster, element, setFocused) {
    super(tabster, element, DummyInputManagerPriorities.Root, undefined, true);
...
class Root extends TabsterPart {
  ...
  addDummyInputs() {
    if (!this._dummyManager) {
      this._dummyManager = new RootDummyManager(this._tabster, this._element, this._setFocused);
    }
  }
...
class Modalizer extends TabsterPart {
  constructor(tabster, element, onDispose, props, activeElements) {
    super(tabster, element, props);
    this._wasFocused = 0;
    ...
    if (!tabster.controlTab) {
      this.dummyManager = new ModalizerDummyManager(this._element, tabster);
    }
...
class ModalizerAPI {
  ...
  createModalizer(element, props) {
    ...
    const modalizer = new Modalizer(this._tabster, element, this._onModalizerDispose, props, this.activeElements);
    const id = modalizer.id;
...
class MoverAPI {
  constructor(tabster, getWindow) {
    ...
    this._onKeyDown = async e => {
      ...
      if (ctx.isGroupperFirst && ((_b = ctx.groupper) === null || _b === void 0 ? void 0 : _b.isActive(true))) {
        return;
      }
...
function observeMutations(doc, tabster, updateTabsterByAttribute, syncState) {
  ...
  const onMutation = mutations => {
    ...
    (_a = tabster.modalizer) === null || _a === void 0 ? void 0 : _a.hiddenUpdate();
  };
