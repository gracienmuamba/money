...
declare class GroupperDummyManager extends DummyInputManager {
    constructor(element: WeakHTMLElement, groupper: Groupper, tabster: Types.TabsterCore);
}
export declare class Groupper extends TabsterPart<Types.GroupperProps> implements Types.Groupper {
    ...
    constructor(tabster: Types.TabsterCore, element: HTMLElement, onDispose: (groupper: Groupper) => void, props: Types.GroupperProps);
    dispose(): void;
...
export declare class GroupperAPI implements Types.GroupperAPI {
    ...
    private _init;
    dispose(): void;
    createGroupper(element: HTMLElement, props: Types.GroupperProps): Groupper;
