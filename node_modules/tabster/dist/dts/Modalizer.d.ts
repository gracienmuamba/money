...
export declare class Modalizer extends TabsterPart<Types.ModalizerProps> implements Types.Modalizer {
    ...
    constructor(tabster: Types.TabsterCore, element: HTMLElement, onDispose: (modalizer: Modalizer) => void, props: Types.ModalizerProps, activeElements: WeakRef<HTMLElement>[]);
