...
exports.useSkeletonItemStyles_unstable = exports.skeletonItemClassNames = void 0;
const react_1 = /*#__PURE__*/require("@griffel/react");
const react_shared_contexts_1 = /*#__PURE__*/require("@fluentui/react-shared-contexts");
const react_theme_1 = /*#__PURE__*/require("@fluentui/react-theme");
exports.skeletonItemClassNames = {
...
const useRectangleStyles = /*#__PURE__*/react_1.__styles({
  "8": {
    Bqenvij: "f1x82gua"
  },
  "12": {
...
const useCircleSizeStyles = /*#__PURE__*/react_1.__styles({
  root: {
...
const useSkeletonItemStyles_unstable = state => {
  ...
  state.root.className = react_1.mergeClasses(exports.skeletonItemClassNames.root, rootStyles.root, animation === 'wave' && rootStyles.wave, animation === 'wave' && dir === 'rtl' && rootStyles.waveRtl, animation === 'pulse' && rootStyles.pulse, appearance === 'translucent' && rootStyles.translucent, animation === 'pulse' && appearance === 'translucent' && rootStyles.translucentPulse, shape === 'rectangle' && rectStyles.root, shape === 'rectangle' && rectStyles[size], shape === 'square' && sizeStyles[size], shape === 'circle' && circleStyles.root, shape === 'circle' && sizeStyles[size], state.root.className);
  return state;
};
