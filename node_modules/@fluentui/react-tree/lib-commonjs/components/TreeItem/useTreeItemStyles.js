...
exports.useTreeItemStyles_unstable = exports.expandIconInlineStyles = exports.treeItemClassNames = void 0;
const react_1 = /*#__PURE__*/require("@griffel/react");
const react_theme_1 = /*#__PURE__*/require("@fluentui/react-theme");
const react_tabster_1 = /*#__PURE__*/require("@fluentui/react-tabster");
const index_1 = /*#__PURE__*/require("../../contexts/index");
const tokens_1 = /*#__PURE__*/require("../../utils/tokens");
exports.treeItemClassNames = {
  root: 'fui-TreeItem',
 ...
 */
const useExpandIconStyles = /*#__PURE__*/react_1.__styles({
  base: {
    mc9l5x: "f22iagw",
    Bt984gj: "f122n59",
    Brf1p80: "f4d9j23",
 ...
 */
const useActionsStyles = /*#__PURE__*/react_1.__styles({
  base: {
    mc9l5x: "fjseox",
...
exports.expandIconInlineStyles = {
  90: {
...
const useTreeItemStyles_unstable = state => {
  ...
  const appearance = index_1.useTreeContext_unstable(ctx => ctx.appearance);
  const {
    actions,
    subtree,
    expandIcon,
  ...
  state.root.className = react_1.mergeClasses(exports.treeItemClassNames.root, isStaticallyDefinedLevel(level) && rootStyles[`level${level}`], state.root.className);
  state.content.className = react_1.mergeClasses(exports.treeItemClassNames.content, contentStyles.base, contentStyles[appearance], contentStyles.focusIndicator, state.isLeaf && contentStyles.leaf, state.content.className);
  if (expandIcon) {
    expandIcon.className = react_1.mergeClasses(exports.treeItemClassNames.expandIcon, expandIconStyles.base, expandIcon.className);
  }
  if (actions) {
    actions.className = react_1.mergeClasses(exports.treeItemClassNames.actions, actionsStyles.base, showActions && actionsStyles.open, actions.className);
  }
  if (subtree) {
    subtree.className = react_1.mergeClasses(exports.treeItemClassNames.subtree, subtree.className);
  }
  return state;
};
