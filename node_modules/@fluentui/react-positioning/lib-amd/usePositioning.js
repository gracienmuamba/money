    ...
    function usePositioningOptions(options) {
        ...
        return React.useCallback(function (container, arrow) {
            ...
            var middleware = [
                ...
                !pinned && middleware_1.flip({ container: container, flipBoundary: flipBoundary, hasScrollableElement: hasScrollableElement, isRtl: isRtl, fallbackPositions: fallbackPositions }),
                middleware_1.shift({
                    container: container,
