define(["require", "exports", "react", "./useCombobox", "./renderCombobox", "./useComboboxStyles", "../../contexts/useComboboxContextValues", "@fluentui/react-shared-contexts"], function (require, exports, React, useCombobox_1, renderCombobox_1, useComboboxStyles_1, useComboboxContextValues_1, react_shared_contexts_1) {
    "use strict";
    ...
    exports.Combobox = React.forwardRef(function (props, ref) {
        ...
        var useCustomStyles = react_shared_contexts_1.useCustomStyleHooks_unstable().useComboboxStyles_unstable;
