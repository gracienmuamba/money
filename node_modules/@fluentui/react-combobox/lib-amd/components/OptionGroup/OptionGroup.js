define(["require", "exports", "react", "./useOptionGroup", "./renderOptionGroup", "./useOptionGroupStyles", "@fluentui/react-shared-contexts"], function (require, exports, React, useOptionGroup_1, renderOptionGroup_1, useOptionGroupStyles_1, react_shared_contexts_1) {
    "use strict";
    ...
    exports.OptionGroup = React.forwardRef(function (props, ref) {
        ...
        var useCustomStyles = react_shared_contexts_1.useCustomStyleHooks_unstable().useOptionGroupStyles_unstable;
