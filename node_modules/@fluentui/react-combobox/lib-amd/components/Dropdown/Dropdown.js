define(["require", "exports", "react", "./useDropdown", "./renderDropdown", "./useDropdownStyles", "../../contexts/useComboboxContextValues", "@fluentui/react-shared-contexts"], function (require, exports, React, useDropdown_1, renderDropdown_1, useDropdownStyles_1, useComboboxContextValues_1, react_shared_contexts_1) {
    "use strict";
    ...
    exports.Dropdown = React.forwardRef(function (props, ref) {
        ...
        var useCustomStyles = react_shared_contexts_1.useCustomStyleHooks_unstable().useDropdownStyles_unstable;
