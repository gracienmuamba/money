...
export var useChipFoundation = function (props) {
    ...
    var handleTrailingActionInteraction = useCallback(function () {
    ...
    return __assign({ setTrailingAction: setTrailingAction }, foundationWithElements);
};
