...
exports.getAutoColorsForTheme = exports.isDark = exports.getRgb = void 0;
...
var isDark = function (color) {
    var _a = exports.getRgb(color), r = _a.r, g = _a.g, b = _a.b;
...
var getAutoColorsForTheme = function (colors) {
    var autoColors = Object.keys(paletteMap).reduce(function (acc, key) {
        if (colors[key]) {
            var palette_1 = exports.isDark(colors[key])
                ? lightTextPalette
                : darkTextPalette;
    ...
    return tslib_1.__assign(tslib_1.__assign({}, autoColors), colors);
};
exports.getAutoColorsForTheme = getAutoColorsForTheme;
