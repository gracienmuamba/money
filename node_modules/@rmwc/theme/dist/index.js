...
exports.Theme = base_1.createComponent(function Theme(props, ref) {
    ...
    if (wrap) {
        return base_1.wrapChild(tslib_1.__assign(tslib_1.__assign({}, rest), { ref: ref, className: className }));
    }
...
exports.ThemeProvider = base_1.createComponent(function ThemeProvider(props, ref) {
    ...
    var className = base_1.useClassNames(props, [
        wrap &&
            ...
            (
            // @ts-ignore
            (_b = (_a = rest.children) === null || _a === void 0 ? void 0 : _a.props) === null || _b === void 0 ? void 0 : _b.className)
    ]);
