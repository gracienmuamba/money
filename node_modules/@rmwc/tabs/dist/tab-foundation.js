...
exports.useTabFoundation = void 0;
var tslib_1 = require("tslib");
var react_1 = require("react");
var base_1 = require("@rmwc/base");
var tab_1 = require("@material/tab");
var tab_bar_context_1 = require("./tab-bar-context");
var useTabFoundation = function (props) {
    var tabIndicatorApi = react_1.useRef();
    var setTabIndicatorApi = function (api) {
        return (tabIndicatorApi.current = api);
    };
    var contextApi = react_1.useContext(tab_bar_context_1.TabBarContext);
    var id = base_1.useId('tab', props);
    ...
    var tabApi = react_1.useMemo(function () {
        return {
            ...
            computeIndicatorClientRect: function () { var _a; return ((_a = tabIndicatorApi.current) === null || _a === void 0 ? void 0 : _a.computeContentClientRect()) || base_1.emptyClientRect; },
            computeDimensions: function () { return foundation.computeDimensions(); },
            focus: function () { return rootEl.ref && rootEl.ref.focus(); },
            id: id,
            getIndex: function () {
                var _a;
                return ((_a = rootEl.ref) === null || _a === void 0 ? void 0 : _a.parentElement)
    ...
    return tslib_1.__assign(tslib_1.__assign({}, elements), { setTabIndicatorApi: setTabIndicatorApi });
};
exports.useTabFoundation = useTabFoundation;
