...
exports.useTabBarFoundation = void 0;
var tslib_1 = require("tslib");
var react_1 = require("react");
var base_1 = require("@rmwc/base");
var tab_bar_1 = require("@material/tab-bar");
var useTabBarFoundation = function (props) {
    var _a = tslib_1.__read(react_1.useState(props.activeTabIndex || 0), 2), activeTabIndex = _a[0], setActiveTabIndex = _a[1];
    var tabScrollerApi = react_1.useRef();
    var setTabScrollerApi = function (api) {
        return (tabScrollerApi.current = api);
    };
    var tabListRef = react_1.useRef([]);
        ...
        foundation: function (_a) {
            ...
            return new tab_bar_1.MDCTabBarFoundation({
                ...
                getFocusedTabIndex: function () {
                    var _a;
                    var tabElements = [].slice.call((_a = rootEl.ref) === null || _a === void 0 ? void 0 : _a.querySelectorAll(tab_bar_1.MDCTabBarFoundation.strings.TAB_SELECTOR));
    ...
    var handleTabInteraction = react_1.useCallback(function (evt) {
    ...
    react_1.useEffect(function () {
        ...
        var _a = tslib_1.__read([window.scrollX, window.scrollY], 2), scrollX = _a[0], scrollY = _a[1];
    ...
    return tslib_1.__assign(tslib_1.__assign({}, elements), { setTabScrollerApi: setTabScrollerApi, handleTabInteraction: handleTabInteraction, registerTab: registerTab, unregisterTab: unregisterTab });
};
exports.useTabBarFoundation = useTabBarFoundation;
