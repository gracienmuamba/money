...
exports.useTopAppBarFoundation = void 0;
var tslib_1 = require("tslib");
var react_1 = require("react");
var base_1 = require("@rmwc/base");
var top_app_bar_1 = require("@material/top-app-bar");
var useTopAppBarFoundation = function (props) {
    var scrollTargetRef = react_1.useRef(null);
    var navIconRef = react_1.useRef(null);
        ...
        foundation: function (_a) {
            ...
            var adapter = {
                ...
                getTotalActionItems: function () {
                    return rootEl.ref
                        ? rootEl.ref.querySelectorAll(top_app_bar_1.MDCTopAppBarFoundation.strings.ACTION_ITEM_SELECTOR).length
                        : 0;
                }
            };
            var foundation;
    ...
    react_1.useEffect(function () {
        var _a, _b;
        navIconRef.current =
            ((_a = rootEl.ref) === null || _a === void 0 ? void 0 : _a.querySelector(top_app_bar_1.MDCTopAppBarFoundation.strings.NAVIGATION_ICON_SELECTOR)) || null;
...
exports.useTopAppBarFoundation = useTopAppBarFoundation;
