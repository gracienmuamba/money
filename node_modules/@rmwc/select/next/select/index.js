...
var SelectDropdownArrow = function () {
    return (React.createElement("span", { className: "mdc-select__dropdown-icon" },
        React.createElement(Icon, { className: "mdc-select__dropdown-icon-inactive", icon: "arrow_drop_down" }),
        React.createElement(Icon, { className: "mdc-select__dropdown-icon-active", icon: "arrow_drop_up" })));
};
function NativeMenu(props) {
    var selectOptions = props.selectOptions, _a = props.placeholder, placeholder = _a === void 0 ? '' : _a, children = props.children, elementRef = props.elementRef, open = props.open, rest = __rest(props, ["selectOptions", "placeholder", "children", "elementRef", "open"]);
...
var AnchorEl = withRipple({ surface: false })(function (props) {
...
function EnhancedMenu(props) {
    ...
    var currentIndex = 0;
    var className = useClassNames(props, ['mdc-select__menu']);
    var renderOption = function (_a) {
        ...
        return (React.createElement(MenuItem, __assign({ key: label + "-" + option.value, activated: value !== undefined
                ? option.value === value
                : currentIndex - 1 === selectedIndex }, option, { "data-value": option.value }),
            React.createElement("span", { className: "mdc-list-item__text" }, label)));
    };
    return (React.createElement(Menu, __assign({}, rest, { apiRef: menuApiRef, className: className, focusOnOpen: true }),
        !!props.placeholder && (React.createElement(MenuItem, { selected: currentIndex - 1 === selectedIndex, "data-value": "", theme: "textDisabledOnBackground" },
            React.createElement("span", { className: "mdc-list-item__text" }, placeholder))),
...
export var Select = createComponent(function Select(props, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Tag, __assign({}, rootProps, { element: rootEl, ref: ref, className: className }),
            React.createElement(AnchorEl, { className: "mdc-select__anchor", role: "button", "aria-haspopup": "listbox", element: anchorEl, onFocus: handleFocus, onBlur: handleBlur, onClick: handleClick, onKeyDown: handleKeydown, onChange: handleChange, 
                ...
                outlined ? (React.createElement(NotchedOutline, { notch: notchWidth }, renderedLabel)) : (React.createElement(React.Fragment, null,
                    ...
                    renderedLabel)),
                React.createElement("span", { className: "mdc-select__selected-text-container" },
                    React.createElement("span", { className: "mdc-select__selected-text" }, selectedTextContent)),
                React.createElement(SelectDropdownArrow, null),
                !enhanced && (React.createElement(NativeMenu, __assign({}, rest, { value: value, children: children, defaultValue: defaultValue, placeholder: placeholder, selectOptions: selectOptions, elementRef: setNativeControl, onFocus: handleFocus, onBlur: function (evt) {
                        handleBlur(evt);
