    ...
    return (react_1.default.createElement(_doc_utils_1.Docs, { title: "Radio Buttons", lead: "Radio buttons allow the user to select one option from a set. Use radio buttons for exclusive selection if you think that the user needs to see all available options side-by-side.", module: "@rmwc/radio", styles: [
        ...
        react_1.default.createElement(_doc_utils_1.DocsExample, null, function Example() {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(_1.Radio, { value: "cookies", checked: value === 'cookies', onChange: function (evt) { return setValue(String(evt.currentTarget.value)); } }, "Cookies"),
                react_1.default.createElement(_1.Radio, { value: "pizza", checked: value === 'pizza', onChange: function (evt) { return setValue(String(evt.currentTarget.value)); } }, "Pizza"),
                react_1.default.createElement(_1.Radio, { value: "icecream", checked: value === 'icecream', onChange: function (evt) { return setValue(String(evt.currentTarget.value)); } }, "Icecream")));
        }),
        ...
        react_1.default.createElement(_doc_utils_1.DocProps, { src: generated_props_json_1.default, components: [{ displayName: 'Radio', component: _1.Radio }] })));
}
