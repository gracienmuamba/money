...
export default function Readme() {
    return (React.createElement(Docs, { title: "Icon Buttons", lead: "Icon buttons allow users to take actions, and make choices, with a single tap.", module: "@rmwc/icon-button", styles: [
        ...
        ], docsLink: "https://material.io/develop/web/components/buttons/icon-buttons/", examples: examples },
        ...
        React.createElement(DocProps, { src: propsSrc, components: [{ displayName: 'IconButton', component: IconButton }] })));
}
