...
var LinearProgressDocs = react_1.default.lazy(function () { return Promise.resolve().then(function () { return tslib_1.__importStar(require('@rmwc/linear-progress/readme')); }); });
var CircularProgressDocsDocs = react_1.default.lazy(function () { return Promise.resolve().then(function () { return tslib_1.__importStar(require('@rmwc/circular-progress/readme')); }); });
...
var ListCollapsibleDocs = react_1.default.lazy(function () { return Promise.resolve().then(function () { return tslib_1.__importStar(require('@rmwc/list/readme-collapsible')); }); });
...
var Loadable = function (Component) { return function () {
    return (react_1.default.createElement(react_1.default.Suspense, { fallback: react_1.default.createElement(Loading, null) },
...
exports.galleryContent = exports.menuContent
    ...
    if ('options' in item) {
        acc.push.apply(acc, tslib_1.__spreadArray([], tslib_1.__read((item.options || []))));
    }
    else {
        acc.push(item);
    }
