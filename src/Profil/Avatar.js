...
export const LetteRName = () => {
  ...
  React.useEffect(async () => {
    ...
    const toCollection = pushDocs.includes(secureLocalStorage.getItem("USER"));
    const unsub = onSnapshot(doc(db, toCollection ? "client" : "agent", secureLocalStorage.getItem("USER")), (doc) => {
